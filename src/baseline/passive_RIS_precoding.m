function [W, Theta, Rsum]= passive_RIS_precoding(M,K,N,Ps_max,sigma2,eta_k,Theta,W,h_k,f_k,G)
iteration=30;
...
[Rsum(2*Q-1),gamma_k] = SINR_calculate(K,M,N,eta_k,h_k,f_k,G,Theta,w_k,sigma2,0);
...
if Q>5
    if (Rsum(2*Q)-Rsum(2*Q-1))/Rsum(2*Q-1)<0.001
        break;
    end
end
